...
export const canisterId = process.env.CANISTER_ID_AUTHENTICATION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./authentication.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the authentication canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./authentication.did.js")._SERVICE>}
 */

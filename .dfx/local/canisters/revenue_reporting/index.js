...
import { idlFactory } from './revenue_reporting.did.js';
export { idlFactory } from './revenue_reporting.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REVENUE_REPORTING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./revenue_reporting.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the revenue_reporting canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./revenue_reporting.did.js")._SERVICE>}
 */
export const revenue_reporting = createActor(canisterId);

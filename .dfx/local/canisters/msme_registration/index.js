...
import { idlFactory } from './msme_registration.did.js';
export { idlFactory } from './msme_registration.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_MSME_REGISTRATION;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./msme_registration.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the msme_registration canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./msme_registration.did.js")._SERVICE>}
 */
export const msme_registration = createActor(canisterId);

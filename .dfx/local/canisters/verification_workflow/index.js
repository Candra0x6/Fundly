...
import { idlFactory } from './verification_workflow.did.js';
export { idlFactory } from './verification_workflow.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VERIFICATION_WORKFLOW;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./verification_workflow.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the verification_workflow canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./verification_workflow.did.js")._SERVICE>}
 */
export const verification_workflow = createActor(canisterId);
